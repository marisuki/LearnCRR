...
class _LinearForest(BaseEstimator):
    ...
    def _fit(self, X, y, sample_weight=None):
        ...
        self._num_rules = len(self.forest_estimator_.get_params(True))
        print(self.forest_estimator_.get_params(True))
        print(self.forest_estimator_.get_params(False))
        print(self._num_rules)
